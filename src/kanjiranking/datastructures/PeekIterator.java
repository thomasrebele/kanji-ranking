 ...
 * 
 * 
 * This class provides an Iterator that can look ahead. With the method peek(),
 * you
 ...
 * </PRE>
 * 
 * The class is also suited to create an Interator by overriding. The only
 * method that
...
public abstract class PeekIterator<T> implements Iterator<T>, Iterable<T>, Closeable {
	...
	/**
	 * A PeekIterator that can iterate over another iterator or over a list of
	 * elements
	 */
	public static class SimplePeekIterator<T> extends PeekIterator<T> {
		...
		/**
		 * Returns the next or NULL if no next element is available. To be
		 * overwritten
		 */
		@Override
		...
		public SimplePeekIterator(@SuppressWarnings("unchecked") T... elements) {
